...
class HashValidatorTest {
    ...
    @Test
    void validate() {
        var hash = "fc8fdb07f0cd97eed41f68fd7ee2e2b167d78be67bd55d657fa334b8960bf7b5";
        ...
        var actual = hashValidator.validate(new TelegramAuthenticationToken(telegramUser, hash));
    ...
    void validateShouldCorrectWorkWithNullFields() {
        var hash = "31788de82422ffafed19d359888f2df0b301155cd030e293c701eeeb39d3d083";
